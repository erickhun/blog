...
- Mark got the idea for [alchemist.camp, an Elixir-learning screencast and tutorial website](https://alchemist.camp),  while working on a video chat startup. He wanted to share technical skills he learned from that startup. When it failed, he started making tutorials on YouTube and is now making $1500 per month.
