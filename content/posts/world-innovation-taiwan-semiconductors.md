...
It’s also not only money, it’s semiconductor physics. Intel is not having the issues they have today because they lack time or money, but probably lack of better experts.  The number of engineers that has the knowledge on how to put together the chips is so small , compared to the amount of software engineers or hardware engineers on the planet. [It isn’t a big field for [Electric Engineer graduates](https://datausa.io/profile/cip/electrical-engineering#:~:text=The%20number%20of%20Engineering%20graduates,to%204.48M%20in%202018.). The problem is finding and hiring them, and you want the best ones.
